...
final class Version20260330002510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE is_verified is_verified TINYINT NOT NULL, CHANGE provider provider VARCHAR(50) DEFAULT NULL, CHANGE google_id verification_token VARCHAR(255) DEFAULT NULL');
    }
